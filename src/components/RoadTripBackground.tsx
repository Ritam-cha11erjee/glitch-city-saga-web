    ...
    <div className="fixed inset-0 overflow-hidden bg-gradient-to-b from-gray-900 via-purple-900 to-indigo-800">
      ...
      >
        <div className="relative">
          <div className="w-80 h-40 bg-white rounded-lg shadow-lg">
            {/* SUV body */}
            <div className="absolute top-0 left-0 w-full h-24 bg-white rounded-t-lg"></div>
            <div className="absolute bottom-0 left-0 w-full h-16 bg-white rounded-b-lg"></div>
            
            {/* Windows */}
            <div className="absolute top-4 left-16 w-48 h-12 bg-blue-200 border border-gray-300"></div>
